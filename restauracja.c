...
static const int CENY_DAN[6] = {p15, p20, p40, p50, p60}; // ceny dań;
int kuchnia_dania_wydane[6] = {0};                        // liczba wydanych dań przez kuchnię
int kasa_dania_sprzedane[6] = {0};                        // liczba sprzedanych dań przez kasę
...
int main()
{
    ...
    *kuchnia_dania_wydane = tasma + 1;
    *kasa_dania_sprzedane = kuchnia_dania_wydane[5] + 1;
    sygnal_kierownika = kasa_dania_sprzedane[5] + 1;
